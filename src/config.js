...
const schema = z.object({
  ...
  FISH_AUDIO_TTS_STREAM_LATENCY: z.enum(['balanced', 'normal', 'low']).default('balanced'),
  FISH_AUDIO_TTS_STREAM_CHUNK_LENGTH: z.coerce.number().int().min(80).max(300).default(100),
  FISH_AUDIO_TTS_STREAM_MIN_CHUNK_LENGTH: z.coerce.number().int().min(20).max(160).default(40),
  ...
  FISH_AUDIO_TTS_MAX_CHARS: z.coerce.number().int().min(120).max(500).default(320),
  ...
  VOICE_TTS_MAX_CHARS: z.coerce.number().int().min(120).max(900).default(280),
