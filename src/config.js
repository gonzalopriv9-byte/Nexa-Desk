...
const schema = z.object({
  ...
  AI_REPLY_TIMEOUT_MS: z.coerce.number().int().min(5000).max(120000).default(35000),
  AI_TYPING_INTERVAL_MS: z.coerce.number().int().min(3000).max(9000).default(7000),
  AI_SLOW_LOG_MS: z.coerce.number().int().min(1000).max(60000).default(12000),
