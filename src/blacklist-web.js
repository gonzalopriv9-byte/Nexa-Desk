...
export function renderBlacklistPage({ query = '', record = null, error = '', isOwner = false } = {}) {
  ...
  const content = error
    ...
    : record
      ...
      : query
        ? '<section class="notice"><strong>No se encontró ningún registro.</strong><span>Comprueba el ID, username de Discord o código de baneo global e inténtalo de nuevo.</span></section>'
